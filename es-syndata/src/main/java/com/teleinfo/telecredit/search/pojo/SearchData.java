...
*/
@Entity
@Table(name = "TC_SEARCH_DATA1",indexes = { @Index(columnList="id") })
@NamedQuery(name = "SearchData.findAll", query = "SELECT t FROM SearchData t")
public class SearchData {
	...
	public SearchData(Long id, String ent_name, String ent_num, String ent_legalperson, String suggest_ent_name,
